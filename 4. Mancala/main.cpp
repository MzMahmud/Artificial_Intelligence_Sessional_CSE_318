...
//0->draw,-1 left heuristic won,+1 right heuristic won
...
int main(int argc, char const *argv[]) {
    ...
    play_n_games_with_randomPlayer(100,1,PLAYER_B);
    play_n_games_with_randomPlayer(100,2,PLAYER_B);
    play_n_games_with_randomPlayer(100,3,PLAYER_B);
    play_n_games_with_randomPlayer(100,4,PLAYER_B);
